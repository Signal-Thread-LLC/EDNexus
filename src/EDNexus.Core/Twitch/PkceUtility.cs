...
/// <summary>
/// RFC 7636 (PKCE) helpers used by <see cref="TwitchAuthService"/> for the desktop↔EBS leg of the
/// login flow: a random code verifier, its SHA-256 "S256" challenge, and an unrelated random CSRF
/// state token for the authorization request. Pure/static and side-effect free, so it needs no
/// mocking to test.
/// </summary>
